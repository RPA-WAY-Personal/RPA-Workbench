...
namespace RPA_Workbench.Views.WFDesigner
{
    public class Workflow : apibase, IWorkflow
    {
        ...
        public void SaveFile(string overridepath = null, bool exportImages = false)
        {
            ...
            if (exportImages)
            {
                GenericTools.RunUI(async () =>
                {
                    ...
                    string xaml = await Views.WFDesigner.WFDesigner.LoadImages(beforexaml);
        ...
        public IWorkflowInstance CreateInstance(Dictionary<string, object> Parameters, string queuename, string correlationId,
            RPA.Workbench.Interfaces.idleOrComplete idleOrComplete, RPA.Workbench.Interfaces.VisualTrackingHandler VisualTracking, string SpanId, string ParentSpanId)
        {
