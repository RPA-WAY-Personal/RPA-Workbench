...
namespace RPA.Workbench.CodeEditor
{
    ...
    public class CodeEditor : TextEditor, INotifyPropertyChanged
    {
        ...
        public CodeEditor()
        {
            ...
            Application.Current.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/RPA.Workbench.CodeEditor;component/Resources/ImageResources.xaml") });
            Application.Current.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/RPA.Workbench.CodeEditor;component/Resources/CodeEditorResources.xaml") });
