...
namespace RPA.Workbench.Windows
{
    ...
    [LocalizedToolboxTooltip("activity_typetext_tooltip")]
    [LocalizedDisplayName("activity_typetext")]
    public class TypeText : CodeActivity
    {
        [RequiredArgument, LocalizedDisplayName("activity_text"), LocalizedDescription("activity_displayname_help")]
        public InArgument<string> Text { get; set; }
        [LocalizedDisplayName("activity_clickdelay"), LocalizedDescription("activity_clickdelay_help")]
