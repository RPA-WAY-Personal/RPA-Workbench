...
namespace RPA.Workbench.Windows
{
    public partial class GetElementDesigner : INotifyPropertyChanged
    {
        ...
        {
            InitializeComponent();
            HighlightImage = RPA.Workbench.Interfaces.Extensions.GetImageSourceFromResource("search.png");
        }
        ...
        private void Open_Selector(object sender, RoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(SelectorString)) {
                ...
                selectors = new RPA.Workbench.Interfaces.Selector.SelectorWindow("Windows", selector, anchor, maxresults);
            } else
            {
        ...
        private void Highlight_Click(object sender, RoutedEventArgs e)
        {
            ...
            Task.Run(() =>
            {
                var elements = new List<RPA.Workbench.UIElement>();
                if (anchor != null)
                {
                ...
                if (elements.Count() > 0)
                {
                    HighlightImage = RPA.Workbench.Interfaces.Extensions.GetImageSourceFromResource("check.png");
                } else
                {
                    HighlightImage = RPA.Workbench.Interfaces.Extensions.GetImageSourceFromResource(".x.png");
                }
                NotifyPropertyChanged("HighlightImage");
        ...
        public BitmapImage Image
        {
            get
            {
                ...
                System.Drawing.Bitmap b = Task.Run(() => {
                    return RPA.Workbench.Interfaces.Image.Util.LoadBitmap(image);
                }).Result;
                using (b)
                {
                    if (b == null) return null;
                    return RPA.Workbench.Interfaces.Image.Util.BitmapToImageSource(b, RPA.Workbench.Interfaces.Image.Util.ActivityPreviewImageWidth, RPA.Workbench.Interfaces.Image.Util.ActivityPreviewImageHeight);
                }
            }
        }
