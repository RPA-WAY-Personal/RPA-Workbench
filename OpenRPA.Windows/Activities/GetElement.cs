...
namespace RPA.Workbench.Windows
{
    ...
    public class GetElement : BreakableLoop, System.Activities.Presentation.IActivityTemplateFactory
    {
        ...
        protected override void StartLoop(NativeActivityContext context)
        {
            ...
            selector = RPA.Workbench.Interfaces.Selector.Selector.ReplaceVariables(selector, context.DataContext);
            ...
            do
            {
                ...
                {
                    elements = RPA.Workbench.Interfaces.AutomationHelper.RunSTAThread<UIElement[]>(() =>
                    {
                        try
                        {
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            RPA.Workbench.Interfaces.Extensions.AddCacheArgument(metadata, "Selector", Selector);
            RPA.Workbench.Interfaces.Extensions.AddCacheArgument(metadata, "From", From);
            RPA.Workbench.Interfaces.Extensions.AddCacheArgument(metadata, "Elements", Elements);
            RPA.Workbench.Interfaces.Extensions.AddCacheArgument(metadata, "MaxResults", MaxResults);
        ...
        public Activity Create(System.Windows.DependencyObject target)
        {
            ...
            Type t = Type.GetType("RPA.Workbench.Windows.ClickElement");
