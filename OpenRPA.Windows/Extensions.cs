...
namespace RPA.Workbench.Windows
{
    ...
    {
        public static AndCondition GetConditionsWithoutStar(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
            using (var automation = RPA.Workbench.Interfaces.AutomationUtil.getAutomation())
            {
        ...
        public static string Title(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
            var e = item.Properties.Where(x => x.Name == "Title").FirstOrDefault();
            if (e == null) return null;
            return e.Value;
        }
        public static bool Index(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
        ...
        public static bool SearchDescendants(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
        ...
        public static string processname(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
            var e = item.Properties.Where(x => x.Name == "processname").FirstOrDefault();
            if (e == null) return null;
            return e.Value;
        }
        public static bool isImmersiveProcess(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
        ...
        public static string ControlType(this RPA.Workbench.Interfaces.Selector.SelectorItem item)
        {
